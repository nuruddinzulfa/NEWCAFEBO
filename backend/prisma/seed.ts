...
async function main() {
  ...
  const menus = [
    ...
    {
      name: "Matcha Latte",
      description: "Minuman matcha dengan susu segar, cocok sebagai dessert",
      price: 35000,
      imageUrl: "matcha.jpeg",
      categoryId: kategoriDessert.id,
      isRecommended: true,
    },
    {
    ...
    {
      name: "Tiramisu",
      description: "Kue tiramisu lembut dengan rasa kopi dan coklat",
      price: 38000,
      imageUrl: "Dessert 1.webp",
      categoryId: kategoriDessert.id,
      isRecommended: true,
    },
    {
      name: "Cheesecake",
      description: "Kue keju panggang dengan tekstur lembut dan creamy",
      price: 42000,
      imageUrl: "Dessert 2.webp",
      categoryId: kategoriDessert.id,
      isRecommended: false,
    },
    {
      name: "Puding Coklat",
      description: "Puding coklat homemade dengan saus vela",
      price: 28000,
      imageUrl: "dessert 3.webp",
      categoryId: kategoriDessert.id,
      isRecommended: false,
    },
  ];
